...
4. **Avatares como emoji.** Subir imágenes implica storage, validación de contenido y resizing; fuera del MVP. `avatarEmoji` guarda un emoji corto. La arquitectura admite añadir URLs más adelante.
